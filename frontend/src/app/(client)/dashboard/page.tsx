        ...
        <div className="col-span-full">
          <Card shadow="lg">
            <CardHeader title="From your Weekly Meal Plan">
              <Button variant='link' as={Link} href="/meal-plan">Go to Meal Plan<span className="hidden sm:inline"> -&gt;</span></Button>
            </CardHeader>
            <CardBody padding='sm'>
              <Banner>
            ...
            <CardBody>
              <List>
                <ListHeader>
                  <>
                    ...
                    <div className="shrink-0 self-end ml-2">
                      <Button variant='link' as={Link} href="/collections">View All<span className="hidden sm:inline"> -&gt;</span></Button>
                    </div>
                  </>
                </ListHeader>
                ...
                {recentCollections.items.length > 0 ? recentCollections.items.map(({ name, id }) => (
                  <ListItem key={id}>
                    <Button variant='link' as={Link} href={`/collections/${id}`}>{name}</Button>
                  </ListItem>))
                  :
        ...
        <div className="col-span-full xl:col-span-8">
          {recentRecipes && recentRecipes.items && <Card shadow="lg">
            <CardHeader title="Recently Added Recipes">
              <Button variant='link' as={Link} href="/recipes">View All<span className="hidden sm:inline"> -&gt;</span></Button>
            </CardHeader>
            <CardBody padding='sm'>
