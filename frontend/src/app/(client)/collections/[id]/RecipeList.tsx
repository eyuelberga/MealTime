...
import { getAllByCollection } from '@/api/recipes';
...
async function RecipeList({collectionId, searchParams }: RecipeListProps) {
    const data: {
        ...
        currentItems: number,
        size: number
    } = (await getAllByCollection(collectionId, searchParams)).data;
