                                ...
                                <List>
                                    <ListHeader>
                                        ...
                                        <div className="shrink-0 self-end ml-2">
                                            <Button variant='outline' as={Link} href={`/meal-plan/create?recipe=${data.id}`}><CalendarIcon />Add To Plan</Button>
                                        </div>
                                    </ListHeader>
                                                ...
                                                <ListItem key={date}>
                                                    <div>
                                                        ...
                                                        <h3 className="text-gray-800">
                                                            ...
                                                            <Button variant='link' as={Link} href={`/meal-plan?view=day&date=${format(addDays(new Date(date), 1), 'yyyy-MM-dd')}`}>{mealType} - on  {new Date(date).toDateString()}</Button>
