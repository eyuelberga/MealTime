                    ...
                    <td className="border p-1 h-36">
                        <div>
                            {mealPlanLookup && mealPlanLookup[mealPlanKey] && mealPlanLookup[mealPlanKey].length > 0 && mealPlanLookup[mealPlanKey]
                                ...
                                >
                                    <Button variant="outline" as={Link} target="_blank" href={`/recipes/${mealPlan.recipe.id}`} ><OpenIcon /> Open</Button>
                                    <Button variant="outline" as={Link} href={`/meal-plan/edit?id=${mealPlan.id}`} ><EditIcon /> Edit</Button>
